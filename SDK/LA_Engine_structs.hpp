...
struct FMobileColorGradingParams
{
	...
	float                                              Blend;                                                    // 0x0004(0x0004) (Edit, Interp)
	float                                              Desaturation;                                             // 0x0008(0x0004) (Edit, Interp)
	struct FLinearColor                                HighLights;                                               // 0x000C(0x0010) (Edit, Interp)
	struct FLinearColor                                MidTones;                                                 // 0x001C(0x0010) (Edit, Interp)
	struct FLinearColor                                Shadows;                                                  // 0x002C(0x0010) (Edit, Interp)
};
...
struct FPostProcessSettings
{
	...
	float                                              Scene_TonemapperRange;                                    // 0x0084(0x0004) (Edit, Interp)
	float                                              Scene_TonemapperToeFactor;                                // 0x0088(0x0004) (Edit, Interp)
	float                                              Scene_ImageGrainScale;                                    // 0x008C(0x0004) (Edit, Interp)
	struct FVector                                     Scene_HighLights;                                         // 0x0090(0x000C) (Edit, Interp)
	struct FVector                                     Scene_MidTones;                                           // 0x009C(0x000C) (Edit, Interp)
	struct FVector                                     Scene_Shadows;                                            // 0x00A8(0x000C) (Edit, Interp)
	...
	struct FMobileColorGradingParams                   MobileColorGrading;                                       // 0x0104(0x003C) (Edit, Interp)
	struct FMobilePostProcessSettings                  MobilePostProcess;                                        // 0x0140(0x0034) (Edit, Interp)
};
...
struct FAnimNotifyEvent
{
	...
	struct FName                                       Comment;                                                  // 0x000C(0x0008) (Edit, EditorOnly)
...
struct FMaterialReferenceList
{
	...
	TArray<struct FInterpTrackMaterialRef>             AffectedInterpTrackMaterialRefs;                          // 0x0028(0x0010) (NeedCtorLink, EditHide)
};
...
struct FSeqOpInputLink
{
	...
	unsigned long                                      bMoving : 1;                                              // 0x0030(0x0004) (Transient, EditorOnly)
	unsigned long                                      bClampedMax : 1;                                          // 0x0030(0x0004) (EditorOnly)
	unsigned long                                      bClampedMin : 1;                                          // 0x0030(0x0004) (EditorOnly)
	int                                                OverrideDelta;                                            // 0x0034(0x0004) (EditorOnly)
};
...
struct FSeqOpOutputLink
{
	...
	unsigned long                                      bMoving : 1;                                              // 0x0034(0x0004) (Transient, EditorOnly)
	unsigned long                                      bClampedMax : 1;                                          // 0x0034(0x0004) (EditorOnly)
	unsigned long                                      bClampedMin : 1;                                          // 0x0034(0x0004) (EditorOnly)
	int                                                OverrideDelta;                                            // 0x0038(0x0004) (EditorOnly)
	float                                              PIEActivationTime;                                        // 0x003C(0x0004) (Transient, EditorOnly)
	unsigned long                                      bIsActivated : 1;                                         // 0x0040(0x0004) (Transient, NoImport, NonTransactional, EditorOnly)
	unsigned long                                      bUseConnectionColor : 1;                                  // 0x0040(0x0004) (EditorOnly)
	struct FColor                                      ConnectionColor;                                          // 0x0044(0x0004) (EditorOnly)
};
...
struct FSeqVarLink
{
	...
	unsigned long                                      bMoving : 1;                                              // 0x0050(0x0004) (Transient, EditorOnly)
	unsigned long                                      bClampedMax : 1;                                          // 0x0050(0x0004) (EditorOnly)
	unsigned long                                      bClampedMin : 1;                                          // 0x0050(0x0004) (EditorOnly)
...
struct FLandscapeLayerStruct
{
	...
	unsigned long                                      bSelected : 1;                                            // 0x001C(0x0004) (Transient, EditorOnly)
...
struct FLandscapeLayerInfo
{
	...
	unsigned long                                      bNoWeightBlend : 1;                                       // 0x000C(0x0004) (EditorOnly)
	...
	unsigned long                                      bSelected : 1;                                            // 0x0020(0x0004) (Transient, EditorOnly)
...
{
	struct FVector                                     Corners[0x4];                                             // 0x0000(0x000C) (EditorOnly)
};
