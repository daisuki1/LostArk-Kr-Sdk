...
public:
	...
	struct FScriptDelegate                             __OnPostAdvance__Delegate;                                // 0x021C(0x0010) (NeedCtorLink)
...
{
public:
	struct FScriptDelegate                             __EventListener__Delegate;                                // 0x00EC(0x0010) (NeedCtorLink)
...
public:
	...
	struct FString                                     SourceFile;                                               // 0x0094(0x0010) (Edit, NeedCtorLink, EditorOnly)
	...
	struct FString                                     SourceFileTimestamp;                                      // 0x00BC(0x0010) (Edit, EditConst, NeedCtorLink, EditorOnly)
	int                                                RTTextures;                                               // 0x00CC(0x0004)
	int                                                RTVideoTextures;                                          // 0x00D0(0x0004)
	struct FQWord                                      ImportTimeStamp;                                          // 0x00D4(0x0008) (Const, Transient, EditorOnly)
